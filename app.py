...
@st.cache_resource
def load_pipeline():
    # Attempt to load the exact weights generated by the User's Kaggle Notebook 
    return KYCPipeline(df_image_model_path="best_deepfake_resnet18.pth", df_video_model_path="best_cnn_lstm_facecrop.pth", device=device)
